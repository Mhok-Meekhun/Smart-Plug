...
export function ProvisioningWizard() {
  ...
  return <div className="stagger-in grid gap-6 xl:grid-cols-[.72fr_1.28fr]">
    <aside className="panel setup-step h-fit p-6 md:p-7">
    ...
    <section className="space-y-5">
      <div className="panel setup-step p-6 md:p-7">
      ...
      <form onSubmit={claim} className="panel setup-step p-6 md:p-7">
